...
<body>
	...
	<div align="center">
		...
		<p class="stepupP">段階を踏んでレベルアップしよう！<br></p>
		<p class="stepupP2">好きなレベルを選んで記事を投稿しよう！<br>
		チュートリアルを見たい時は、「チュートリアルを見る」の横にある<br>
		ボックスをクリックして、チェックを入れてからレベルを選択してね！</p>
