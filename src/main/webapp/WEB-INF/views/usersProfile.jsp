...
<link href="css/mocP2.css" rel="stylesheet">
...
<p class="form-title">木村さんのプロフィール<br></p>

<form action="usersMypage.html" method="post">

        <p class="idText">ID</p>
        <p class="id"><input type="text" name="id" value="kimukimu" readonly/></p>

        <p class="nameText">名前</p>
        <p class="name"><input type="text" name="name" value="きゃむ" readonly /></p>

        <p class="passText">PASS</p>
        <p class="pass"><input type="text" name="pass" value="pass" readonly/></p>
...
日 <br>  </p>
        ...
        <p class="hoby"><input type="text" name="hobby" value="ボーリング" readonly/></p>

        <p class="comText">コメント</p>
        <p class="com"><input type="text" name="comment" value="八重洲万歳" readonly/></p>
