...
<p id="headM">１箇所以上の項目を変更してください<br>
※IDは変更できません</p>

<form action="usersUpdateConfirm.html" method="post">
        <p class="idText">ID</p>
        <p class="id"><input type="text" name="id" value="kimukimu" style ="background-color:gray;" readonly/></p>

        <p class="nameText">名前</p>
        <p class="id"><input type="text" name="name" value="きゃむ"/></p>

        <p class="passText">PASS</p>
        <p class="id"><input type="text" name="pass" value="pass"/></p>
...
日 <br>  </p>
        ...
        <p class="id"><input type="text" name="hobby" value="ダーツ" /></p>
        ...
        <div id="center_yose">
		<a href="usersUpdateConfirm.html" class="fl_tw4">
			<span>確認</span>
		</a>
		</div>
</form>
