...
<body>
	<div class="center">
		...
		<div class="box30">
			<p class="box-title">会員情報 変更ページ</p>

			<p class="headN">あなたのプロフィールを教えてください！</p>

			<form:form action="usersUpdateConfirm" modelAttribute="form">
				<p class="idTextr">ID:${beforeUser.userId}</p>

				<label class="nameText">名前</label>
				<p>
					<form:input path="newuserName" value="${beforeUser.userName}" />
				</p>
				<br>
				<br>
				<label class="nameText">性別</label>
				<p class="id">
					男&nbsp; 女
				...
				<label class="nameText">誕生日 ${beforeUser.birthday}</label>
				<p class="id">
				...
				<p class="id">
					<form:input path="newHobby" value="${beforeUser.hobby}" />
				</p>

				<p class="comText">コメント</p>
				<p class="id">
					<textarea cols="30" rows="3" maxlength="10" name="newGreet">${login.greet}
					</textarea>
				</p>
