		...
		<div align="center">
			<div class="start">
				...
				<div class="bun">
					...
					初級では、文字の入力と画像の挿入ができます。<br><br>


					①テキストエリアをクリックして文字を入力してみましょう。<br> <br>
					<img src="image/"><br> <br>

					②次に、画像を挿入してみましょう。<br> <br>
					<img src="image/"><br> <br>

					初級のステップは以上です！<br>
					それでは下のリンクをクリックして、実際に記事を投稿してみましょう！<br> <br>
				...
				<div class="footer">
					<br> <br> <br>
					<p class="let">
						<a href="easyContribution">初級の記事投稿ページへ！</a>
					</p>
				</div>
			</div>
		</div>
