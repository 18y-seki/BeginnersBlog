...
<table class="brwsr2">
	<tbody>
	<tr><th class="tr2"></><th class="tr2">記事タイトル</><th class="tr2">カテゴリ</><th class="tr2">記事本文</><th class="tr2"></>
	</>
    <tbody>
        <tr>
        ...
        <tr>
            ...
            <th><a href="sample3">今日のご飯</a></th>
                        <td class="nd"><img src="kategori.png" class="Kimg">　おすすめのご飯</td>
            <td class="data fst">
               私の好きなお店やまや<br>
				明太子と高菜が食べ放題だよ！
            </td>
