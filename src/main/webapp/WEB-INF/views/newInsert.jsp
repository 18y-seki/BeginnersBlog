...
<body id="top">
	...
	<form action="newInsertConfirm" method="post">
		...
		<div id="formNew2">
			<p id="headNu">
				<strong>①</strong>数字を<strong>8文字</strong>入力してください。<br>
				（例）12345678
			</p>
		...
		<div id="formNew2">
			<p id="headNu">
				<strong>②</strong>あなたのお名前、またはニックネームを入力してください。<br> （例）山田太郎、きむ
			</p>
		...
		<div id="formNew2">
			<p id="headNu">
				<strong>③</strong>英語と数字組み合わせ、<strong>4文字</strong>入力してください。<br>
				（例）12ab、123k、AB12
			</p>
